    ...
    <section className="w-full bg-slate-50">
      <div className="flex flex-col items-center justify-center gap-8 px-6 py-12 sm:px-12 sm:py-16 lg:gap-[110px] lg:px-[100px] lg:py-[164px]">
        <div className="flex flex-col gap-[20px]">
          <h2 className="text-[48px] font-bold tracking-[-1.8px] text-[dark-color]">Get your airpod now.</h2>
          <p className="text-center text-[19px] font-normal text-[dark-color] opacity-70">
